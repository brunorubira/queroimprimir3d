...
async function main() {
  ...
  // Clean existing logic could be here if needed, but we'll just create new ones to ensure it works
  ...
  const client = await prisma.user.upsert({
    ...
    create: {
      ...
      password: 'hashed-password-here', // mock
  ...
  // 3. Create a Request from the Client
  ...
  // 4. Create a Proposal from the Provider
  ...
  // 5. Create a Conversation in Chat
